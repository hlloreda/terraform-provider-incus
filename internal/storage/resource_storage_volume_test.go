		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("incus_storage_volume.volume1", "name", volumeName),
					resource.TestCheckResourceAttr("incus_storage_volume.volume1", "pool", poolName),
					resource.TestCheckResourceAttr("incus_storage_volume.volume1", "name", instanceName),
					resource.TestCheckResourceAttr("incus_storage_volume.volume1", "status", "Stopped"),
					resource.TestCheckResourceAttr("incus_storage_volume.volume1", "device.#", "1"),
					resource.TestCheckResourceAttr("incus_storage_volume.volume1", "device.0.name", "volume1"),
					resource.TestCheckResourceAttr("incus_storage_volume.volume1", "device.0.type", "disk"),
					resource.TestCheckResourceAttr("incus_storage_volume.volume1", "device.0.properties.path", "/mnt"),
					resource.TestCheckResourceAttr("incus_storage_volume.volume1", "device.0.properties.pool", poolName),
					resource.TestCheckResourceAttr("incus_storage_volume.volume1", "device.0.properties.source", volumeName),
				),
			},
		},
	})
